/* global Notyf, log, _ */
// These vars will be injected by into the page
import generateRoomWithoutSeparator from "@/contentScript/libs/js/randomName.js";
console.log("test")
console.log(generateRoomWithoutSeparator);
